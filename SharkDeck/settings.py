...
if os.environ.get('DATABASE_NAME'):
    DATABASES = {
        'default': {
            ...
            'TIME_ZONE':os.environ.get('TIME_ZONE',default='America/New_York')
        }
    }
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'swimtimesolutions@gmail.com'
EMAIL_HOST_PASSWORD = 'vavykninjketytrc'
EMAIL_USE_TLS = True
