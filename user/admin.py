...
from .models import User, ReviewRate, Profile, StudentProfile, BreakTime,Kids
from django.contrib.auth.models import Group


class UserAdmin(admin.ModelAdmin):
    list_display = ('email', 'mobile_no', 'user_type', 'verified', 'pk','deactivate')
...
class KidAdmin(admin.ModelAdmin):
    list_display=['kids_name','date_of_birth','parent','status']

admin.site.register(Kids,KidAdmin)
